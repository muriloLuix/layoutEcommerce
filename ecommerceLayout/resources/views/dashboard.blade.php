    ...
    <div class="generalRightSide">
        <div class="duvidas">
            <div class="imagemEchoDuvidas">
                <img src="{{ asset('img/logoEcho/logoEchoDuvidaLaranja.svg') }}" alt="Logo Echo">
            </div>
            <div class="textDuvida">
                ...
                <a href="" class="greenDuvida">Fale Conosco<svg width="20" height="19" viewBox="0 0 12 11" fill="none"
                        ...
                        <path d="M3.65381 7.79134L8.23714 3.20801" stroke="#FF3C00" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M3.65381 3.20801H8.23714V7.79134" stroke="#FF3C00" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                </a>
            </div>
        ...
        <div class="feedback">
            <div class="imagemEchoFeedback">
                <img src="{{ asset(path: 'img/logoEcho/logoEchoFeedbackLaranja.svg') }}" alt="Logo Echo">
            </div>
            <div class="textFeedback">
                <a href="">Dar um feedback para a Echo</a>
                <img src="{{ asset(path: 'img/estrelasFeedback/estrelasFeedbackLaranja.svg') }}"
                    alt="Estrelas Feedback Laranja">
            </div>
        </div>
    </div>
</div>
...
{{-- <section class="banner">
    <div class="bannerContent">
        <img src="{{ asset(path: 'img/produtosBanner/produtoBannerLaranja.svg') }}" alt="Banner Ecommerce">
    </div>
</section> --}}

<section class="banner">
    <div class="bannerContent">
        <img class="logoEcho" src="{{ asset(path: 'img/produtosBanner/logoEchoBanner.svg') }}" alt="Logo Echo">
        <img class="produtoBanner" src="{{ asset(path: 'img/produtosBanner/produtosBannerTeste.svg') }}"
            alt="Banner Ecommerce">
        <button class="btnAlterar"><i class="bi bi-pencil-square"></i>Alterar imagens</button>
    </div>
</section>
...
<section class="feedbackCarousel">
    ...
    <div class="feedbackClientes">
        <div class="personagem">
            <img src="img/personagemFeedback/echoFeedbackLaranja.svg" alt="Echo">
        </div>
    ...
    <div class="btnFeedback">
        <button><i class="bi bi-pencil"></i>Adicionar feedback</button>
    </div>
</section>
...
<section class="loja">
    ...
    <div class="btnLoja">
        <a href="/hub-de-alteracoes">Editar/Adicionar Produtos</a>
    </div>
    <div class="cardsLoja">
